...
Feature: Get recommended programs on homepage
  ...
  Background:
    ...
    And there are programs:
      ...
      | 1  | Game      | p4          | Catrobat1 | 5         | 1     | 01.03.2013 12:00 | 0.8.5   |
      | 2  | Minions   | p1          | Catrobat1 | 3         | 12    | 01.01.2013 12:00 | 0.8.5   |
      | 3  | Galaxy    | p2          | Catrobat1 | 10        | 13    | 01.02.2013 12:00 | 0.8.5   |
      | 4  | Other     | p3          | Catrobat1 | 12        | 9     | 01.02.2013 12:00 | 0.8.5   |
      | 5  | Other2    | p5          | Catrobat1 | 3         | 9     | 01.02.2013 12:00 | 0.8.5   |
      | 6  | Other3    | p6          | Catrobat1 | 1         | 9     | 01.02.2013 12:00 | 0.8.5   |
  ...
  Scenario: Recommend all other unliked programs, liked by similar user (example: #1, "Only one similar user")
    Given there are similar users:
      | first_user_id | second_user_id | similarity |
      | 1             | 2              | 0.3        |
    And there are likes:
  ...
  Scenario: Recommend all other unliked programs, liked by similar user (example: #2 "Three similar users with different similarity values")
    Given there are similar users:
      | first_user_id | second_user_id | similarity |
      | 1             | 2              | 0.1        |
      | 1             | 3              | 0.3        |
    And there are likes:
      ...
      | Catrobat3 | 2          | 1    | 01.01.2017 12:00 |
  ...
  Scenario: Recommend all other unliked programs, liked by similar user (example: #3 "Four similar users with different similarity values")
    Given there are similar users:
      | first_user_id | second_user_id | similarity |
      | 1             | 2              | 0.1        |
      | 1             | 3              | 0.4        |
    ...
    And there are likes:
      ...
      | Catrobat4 | 2          | 1    | 01.01.2017 12:00 |
    Given I have a parameter "user_id" with value "1"
    And I have a parameter "limit" with value "10"
    And I have a parameter "offset" with value "0"
    When I GET "/pocketcode/api/projects/recsys_general_programs.json" with these parameters
